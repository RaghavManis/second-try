        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2.5rem' }}>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, color: '#e2e8f0', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <li style={{ display: 'flex', alignItems: 'flex-start', gap: '0.8rem' }}>
                ...
                <span>Siddha Cricket Ground, Near Kali Mata Mandir, Siddha Ahilaspur<br />Nandaur Bazar, Madhuban Mau - 221603, Uttar Pradesh</span>
              </li>
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              ...
              <a href="https://x.com/raghav_manish24" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-secondary)', background: 'rgba(255,255,255,0.05)', padding: '0.8rem', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.3s' }} className="social-icon hover-lift">
                <Youtube size={22} />
              </a>
